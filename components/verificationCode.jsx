      ...
      <div className="w-full max-w-sm">
        <div className="bg-white  rounded px-8 py-10 pt-6 pb-8 mb-4">
          ...
          <div className="mb-4 flex flex-col justify-center text-center">
            ...
            <p className="text-blue_grey-700 text-xs mt-2">Por favor ingresa el codigo que enviamos al</p>
            <p className="text-blue_grey-700 text-xs ">correo electronico registrado</p>
          </div>
          <div className="mb-4">
