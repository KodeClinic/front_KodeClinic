...
export default function OxxoPayModal({ isVisible }) {
      ...
      >
        ...
        >
          ...
          <div className={clsx("flex", "justify-evenly")}>
            <div className={clsx("flex", "justify-center")}>
              <img
                className={clsx("max-w-30", "m-5")}
                src="/assets/PikPng 1.png"
                alt="OxxoPay"
              />
            </div>
          </div>
          <div className={clsx("grid justify-items-center space-y-4")}>
            <p className={clsx("font-semibold")}> Monto a pagar</p>
            <p>$500MXN</p>
            <p className={clsx("font-semibold")}> Referencia</p>
            <p>93001359641434</p>
          </div>
        </div>
      </div>
